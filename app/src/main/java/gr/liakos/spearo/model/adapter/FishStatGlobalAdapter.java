...
public class FishStatGlobalAdapter extends ArrayAdapter<FishAverageStatistic> {
    ...
    public FishStatGlobalAdapter(Activity activity, int layoutResourceId, List<FishAverageStatistic> stats, boolean isMetric, boolean isPremium) {
        super(activity.getApplicationContext(), layoutResourceId, stats);
        this.layoutResourceId = layoutResourceId;
        this.fishStats = stats;
        this.activity = activity;
        this.isMetric = isMetric;
        this.isPremiumDiagrams = isPremium;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null || !(convertView.getTag() instanceof FishStatisticViewHolderFull)) {
                    convertView = activity.getLayoutInflater().inflate(R.layout.fish_stat_global_row_with_diagrams, parent, false);
                ...
                if (isPremiumDiagrams || position < 2) {
                    ...
                    holder.getGlobalLayout().setVisibility(View.VISIBLE);
                    holder.getNoPremiumLayout().setVisibility(View.GONE);

                    holder.getCarouselView().setViewListener(setupCarouselDiagramsListener(fishStat, holder));

                    holder.getCarouselView().setPageCount(2);
                    ...
                    holder.getGlobalLayout().setVisibility(View.GONE);
                    ...
                    noPremiumButton.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            ((ActSpearoStatsMain) activity).purchasePremiumStats();
    ...
    private void basicConvertViewActions(FishAverageStatistic fishStat, FishStatisticViewHolderFull holder, View convertView) {
    ...
    private void setBasicViews(FishStatisticViewHolderFull holder, View convertView) {
    ...
    private void setCarouselViews(FishStatisticViewHolderFull holder,View convertView,  ViewGroup parent ) {
        holder.setNoPremiumLayout(convertView.findViewById(R.id.fish_stats_no_premium_global_layout));
        holder.setGlobalLayout(convertView.findViewById(R.id.linear_global_layout));

        CarouselView carouselView = convertView.findViewById(R.id.carouselDiagramsViewGlobal);
    ...
    private ViewListener setupCarouselDiagramsListener(FishAverageStatistic fishStat, FishStatisticViewHolderFull holder) {
        return new ViewListener() {
            ...
            public View setViewForPosition(int position) {
                ...
                if (position == 0){
                    ...
                    if (fishStat.getCatchesPerHourPerSeason() != null) {
