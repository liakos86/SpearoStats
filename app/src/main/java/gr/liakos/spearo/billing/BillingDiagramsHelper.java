...
import static gr.liakos.spearo.util.Constants.SKU_PREMIUM_DIAGRAMS;

public class BillingDiagramsHelper implements PurchasesUpdatedListener {
    ...
    public BillingDiagramsHelper(Activity activity){
            ...
            public void onBillingSetupFinished(BillingResult billingResult) {
                ...
                if(billingResult.getResponseCode()==BillingClient.BillingResponseCode.OK){
                    ...
                    //Or purchase is refunded or canceled
                        ...
                        listener.onPurchaseDiagramsAttemptFinished(false);
                ...
                public void onBillingSetupFinished(BillingResult billingResult) {
                    if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                        ...
                        if (null != asyncListener){
                           asyncListener.onPurchaseDiagramsAttemptFinished(false);
                        }
                    }
                }
                @Override
    ...
    private void initiatePurchase() {
        ...
        skuList.add(SKU_PREMIUM_DIAGRAMS);
    ...
    void handlePurchases(List<Purchase>  purchases) {
        for(Purchase purchase:purchases) {
            ...
            if (SKU_PREMIUM_DIAGRAMS.equals(purchase.getSku()) && purchase.getPurchaseState() == Purchase.PurchaseState.PURCHASED)
            {
                ...
                //else item is purchased and also acknowledged
                    ...
                    asyncListener.onPurchaseDiagramsAttemptFinished(true);
                }
            }
            //if purchase is pending
            else if( SKU_PREMIUM_DIAGRAMS.equals(purchase.getSku()) && purchase.getPurchaseState() == Purchase.PurchaseState.PENDING)
            {
                asyncListener.onPurchaseDiagramsAttemptFinished(false);
                Toast.makeText(activity.getApplicationContext(),
            ...
            else if(SKU_PREMIUM_DIAGRAMS.equals(purchase.getSku()) && purchase.getPurchaseState() == Purchase.PurchaseState.UNSPECIFIED_STATE)
            {
                asyncListener.onPurchaseDiagramsAttemptFinished(false);
